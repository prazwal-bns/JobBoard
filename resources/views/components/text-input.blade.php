<div class="relative">
    @if ('textarea' != $type)
        @if ($formRef)
            <button type="button" class="absolute top-0 right-0 flex items-center h-full pr-2"
        ...
        @class([
            'w-full rounded-md border-0 py-1.5 text-sm ring-1 placeholder:text-slate-400 focus:ring-2',
            'pr-8' => $formRef,
